...
# Function to get a randomized version of the dadate_list array for a given element in the roomnumber_list array
#def shuffled_function(element):

# Original arrays gotten from other functions
